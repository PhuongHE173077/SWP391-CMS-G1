<%-- 
    Document   : updateRolePermission
    Created on : Dec 15, 2025, 12:17:21 AM
    Author     : admin
--%>
    ...
    <form action="UpdateRolePermission" method="POST">
                                        ...
                                        <c:forEach var="role" items="${listRoles}">
                                            <td>
                                                ...
                                                <c:forEach var="rp" items="${rolePermissions}">
                                                    <c:if test="${rp.roles.id == role.id && rp.router == router.router}">
        ...
        <div class="mt-3 d-flex justify-content-between align-items-center">
            <small class="text-muted">
                <input type="checkbox" checked disabled class="permission-checkbox" style="width: 15px; height: 15px;"/> = Role có quyền truy cập màn hình này
            </small>
