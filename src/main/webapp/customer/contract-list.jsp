    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <jsp:include page="customerLayout.jsp">
                <jsp:param name="pageTitle" value="Danh Sách Hợp Đồng Của Tôi" />
            </jsp:include>
            ...
            <div class="page-header">
                <h2><i class="fas fa-file-contract me-2" style="color: #667eea;"></i>Danh Sách Hợp Đồng Của Tôi</h2>
                <p class="mb-0">Xem và quản lý tất cả hợp đồng của bạn</p>
            </div>
                                            ...
                                            <c:when test="${itemCount > 0}">
                                                <c:forEach items="${items}" var="item" varStatus="itemStatus">
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <c:set var="startDate" value="${startDateMap[item.id]}" />
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <c:if test="${itemStatus == 'expired' || empty itemStatus}">
                                                                <span class="badge badge-expired">Hết hiệu lực</span>
                                                            </c:if>
                                                        </td>
                    ...
                    <c:if test="${not empty contractList && totalPages > 1}">
                        <div class="card-footer bg-white d-flex justify-content-between align-items-center py-3">
                            <div class="pagination-info">
                                Hiển thị ${(currentPage - 1) * pageSize + 1} - ${currentPage * pageSize > totalContracts
                                ? totalContracts : currentPage * pageSize} trong tổng số ${totalContracts} hợp đồng
                            </div>
