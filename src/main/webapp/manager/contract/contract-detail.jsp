                ...
                <body class="bg-light">
                    <div class="container mt-4 mb-5">
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control fw-bold ${c.isDelete ? 'text-success' : 'text-danger'}"
                                ...
                                <form action="contract-detail" method="get">
                                    ...
                                    <div class="row g-2 mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="searchItem"
                                                    name="searchItem" placeholder="Search" value="${searchItem}">
                                        ...
                                        <div class="col-md-4 d-flex gap-2 align-items-center">
                                            ...
                                            <a href="contract-detail?id=${c.id}"
                                                class="btn btn-outline-secondary px-4 py-2">Reset Filter</a>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="col-md-4 d-flex gap-2 align-items-center">
                            ...
                            <a href="contract-detail?id=${c.id}" class="btn btn-outline-secondary px-4 py-2">Reset
                                Filter</a>
                        </div>
                    </div>
                    </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <c:if test="${empty itemList}">
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-4">No items found in this
                                            contract.</td>
                                    </tr>
                                </c:if>
                            </tbody>
